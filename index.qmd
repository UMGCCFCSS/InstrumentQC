...
Data4L <- Luciernaga:::ShinyQCSummary(x=Gain_3L, Instrument="4L")
Data5L <- Luciernaga:::ShinyQCSummary(x=Gain_3L, Instrument="5L")
DataCS <- Luciernaga:::ShinyQCSummary(x=Gain_3L, Instrument="CS")
